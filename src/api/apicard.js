            ...
            <div key={index}>
                ...
                <div className="container__card" >
                    <div className="container__card__titulo">
                        ...
                        <h3 className="container__card__titulo__marca">{Ofertas.marca} {Ofertas.modelo}</h3>
                    </div>
                    ...
                    <div className="container__card__precio">
                        ...
                        <h3 className="container__card__precio__precio2">$ {Ofertas.preciodolares}</h3>
                    </div>
                    <hr />
